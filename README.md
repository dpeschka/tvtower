...
$$
\mathcal{H}(q)=\int_\Omega \frac{|p|^2}{2\varrho} + W(F)\hskip\mathrm{d}x
$$
...
$$
b(\eta,v):=\int_\Omega \eta\cdot v\hskip\mathrm{d}x\overset{!}{=}\langle \mathrm{D}\mathcal{H}(q),v\rangle
$$
...
$$
j(\eta,\xi)=\int_\Omega \eta_p\cdot\xi_\chi - \xi_p\cdot\eta_\chi\hskip\mathrm{d}x,
$$

and

$$
k(\eta,\xi)=\int_\Omega \mu\nabla\eta_p\cdot\nabla \xi_p\hskip\mathrm{d}x.
$$
